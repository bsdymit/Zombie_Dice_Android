...
public class PlayerQueue
{
	...
	public void addPlayer(String name, char type)
	{
		...
		{
			System.out.println("Sorry, you have reached the maximum amount of players.");
		}
		else if(findPlayer(name) != -1)
		{
			System.out.println("Sorry, the player name entered already exists. Enter a different name.");
		}
		else
		{
	...
	public void removePlayer(String name)
	{
		...
		if(index == -1)
		{
			System.out.println("Sorry, that player does not exist.");
		}
		else
		{
